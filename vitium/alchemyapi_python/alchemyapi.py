...
class AlchemyAPI:
    ...
    def imageTaggingRaw(self, data, options={}):
        """

        INPUT:
        data -> the data to analyze, the image byte array.
        options -> various parameters that can be used to adjust how the API works, see below for more info on the available options.
        """
        options['imagePostMode'] = 'raw'
        return self.__analyze(AlchemyAPI.ENDPOINTS['imagetagging']['image'], options, data)
